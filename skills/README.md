...
|---|---|---|
| `deploy-example` | `/deploy-example <name> <studio-url>` | **One-command deploy of an existing example to a Studio session** |
...
| `build-canvas-app` | `/build-canvas-app <description>` | Generate a NEW Canvas App from a description |
